...
export default function CartPage() {
      ...
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center py-16">
            ...
            <h1 className="text-3xl font-bold text-amber-900 dark:text-amber-100 mb-4">Your Cart is Empty</h1>
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-amber-900 dark:text-amber-100 mb-8">Your Cart</h1>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-amber-900 dark:text-amber-100">{item.name}</h3>
            ...
            <Card className="border-amber-200 dark:border-amber-800 sticky top-4">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <Button variant="outline" className="w-full border-amber-300 bg-transparent">
                    Apply Code
                  </Button>
                </div>
                ...
                <Button asChild variant="outline" className="w-full border-amber-300 bg-transparent">
                  <Link href="/products">Continue Shopping</Link>
                </Button>
