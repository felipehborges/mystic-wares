        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-amber-800 dark:text-amber-200 mb-8">
              Discover legendary weapons, mystical artifacts, and royal
              treasures from ages past
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-amber-700 dark:text-amber-300 max-w-2xl mx-auto">
              Handpicked legendary items from our master craftsmen and ancient
              collectors
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredProducts.map((product) => (
              ...
              >
                ...
                <CardHeader>
                  <CardTitle className="text-amber-900 dark:text-amber-100 line-clamp-1">
                    {product.name}
                  </CardTitle>
      ...
      <section className="py-16 bg-amber-900 dark:bg-amber-950">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-amber-200 mb-8 max-w-2xl mx-auto">
            Subscribe to receive news of new arrivals, exclusive offers, and
